                            ...
                            <div>
                                ...
                                @if ($pelaporan->bukti)
                                    ...
                                    @if (in_array($fileExtension, $imageExtensions))
                                        <img src="{{ asset('storage/' . $pelaporan->bukti) }}" alt="Bukti" class="mt-1 w-full max-w-xs h-auto object-cover rounded-md cursor-pointer" onclick="showImageModal(`{{ asset('storage/' . $pelaporan->bukti) }}`)">
                                    @else
