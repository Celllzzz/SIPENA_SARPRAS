        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="font-heading font-bold text-xl text-gray-900 leading-tight">
                    {{ __('Buat Akun Admin Baru') }}
                </h1>
                <p class="text-xs text-gray-500 mt-1">
                    Tambah administrator baru dengan hak akses penuh ke sistem
                </p>
            </div>
    ...
    <div class="py-6 sm:py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-md shadow-sm border border-gray-200 p-6 sm:p-8">
                <div class="mb-6">
                    <h2 class="font-heading font-bold text-base sm:text-lg text-gray-900">Data Administrator Baru</h2>
                    <p class="text-xs text-gray-500 mt-0.5">Isi rincian akun administrator yang akan dibuat.</p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.store') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="name" class="block w-full border border-gray-300 rounded-md text-xs sm:text-sm text-gray-900 px-3 py-2 focus:border-teal-500 focus:ring-teal-500 shadow-sm" type="text" name="name" value="{{ old('name') }}" required autofocus placeholder="Contoh: Budi Santoso" />
                    ...
                    <div>
                        ...
                        <input id="email" class="block w-full border border-gray-300 rounded-md text-xs sm:text-sm text-gray-900 px-3 py-2 focus:border-teal-500 focus:ring-teal-500 shadow-sm" type="email" name="email" value="{{ old('email') }}" required placeholder="admin@sekolah.sch.id" />
